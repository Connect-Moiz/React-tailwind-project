...
const projects = [
...

    {
        ...
        description: "Full-feated e-commerce platform with user authentication and payment processing.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
         {projects.map((project, key) => (
            ...
            className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover">
              ...
              <div className="p-6">
              <div className="flex flex-wrape gap-2 mb-4">
           ...
           <div className="text-center mt-12">
            ...
            target="_blank"
             href="https://github.com/Connect-Moiz">

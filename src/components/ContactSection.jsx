            ...
            <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
                ...
                <form className="space-y-6">
                    <div>
                     ...
                     <input type="email" id="name" name="name" className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outlind-hidden focus:ring-2 focus:ring-primary"
                     ...
                     <textarea  id="message" name="message" className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outlind-hidden focus:ring-2 focus:ring-primary resize-none"
